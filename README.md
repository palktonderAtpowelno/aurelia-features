...
6. To run the app, execute the following command:
  ...
  gulp watch
  ```
7. Browse to [http://localhost:9001](http://localhost:9001) to see the app. You can make changes in the code found under `src` and the browser should auto-refresh itself as you save files.
